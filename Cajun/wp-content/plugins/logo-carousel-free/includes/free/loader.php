...
class SPLC_Free_Loader {
	...
	public function admin_menu() {
		...
		$landing_page = 'https://shapedplugin.com/logo-carousel/pricing/?ref=1';
		add_submenu_page(
			'edit.php?post_type=sp_logo_carousel',
				...
				<section class="sp-lc-help upgrade">
					...
					<div class="container">
						<div class="upgrade-pro">
							...
							<div class="pro-btn">
								<a href="https://shapedplugin.com/logo-carousel/pricing/?ref=1" target="_blank">Upgrade To Pro Now</a>
							</div>
						</div>
					</div>
				</section>
