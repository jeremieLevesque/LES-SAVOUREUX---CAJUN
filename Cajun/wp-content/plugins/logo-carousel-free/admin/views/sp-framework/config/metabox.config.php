	...
	array(
		...
		'fields' => array(
			array(
				...
				'desc'     => __( 'To unlock Grid, Isotope, List, and Inline layouts and Settings, <b><a href="https://shapedplugin.com/logo-carousel/pricing/?ref=1" target="_blank">Upgrade To Pro</a></b>!', 'logo-carousel-free' ),
				'options'  => array(
					'carousel' => array(
	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'desc'     => __( 'To display logo with content, changing positions, read more button, etc, <a href="https://shapedplugin.com/logo-carousel/pricing/?ref=1" target="_blank"><b>Upgrade To Pro!</b></a>', 'logo-carousel-free' ),
				'default'  => 'default',
			),
			array(
			...
			array(
				'type'    => 'notice',
				'style'   => 'normal',
				'content' => __( 'To unlock the following amazing tooltip settings, <a href="https://shapedplugin.com/logo-carousel/pricing/?ref=1" target="_blank"><b>Upgrade To Pro!</b></a>', 'logo-carousel-free' ),
			),
			array(
				'id'         => 'lcp_logo_tooltip',
				'type'       => 'switcher',
			...
			array(
				'type'    => 'notice',
				'style'   => 'normal',
				'content' => __( 'To unlock logo background, radius, and boxshadow settings, <a href="https://shapedplugin.com/logo-carousel/pricing/?ref=1" target="_blank"><b>Upgrade To Pro!</b></a>', 'logo-carousel-free' ),
			),
			array(
				'id'       => 'lcp_logo_color',
				'type'     => 'color_group',
	...
	array(
		...
		'fields' => array(
			...
			array(
				'type'    => 'notice',
				'style'   => 'normal',
				'content' => __( 'To unlock vertical carousel, slide to scroll, multiple rows carousel, and many more amazing settings, <a href="https://shapedplugin.com/logo-carousel/pricing/?ref=1" target="_blank"><b>Upgrade To Pro!</b></a>', 'logo-carousel-free' ),
			),
			array(
				'type'    => 'subheading',
	...
	array(
		...
		'fields' => array(
			array(
				'type'    => 'notice',
				'style'   => 'normal',
				'content' => __( 'To unlock the following Typography (950+ Google Fonts) options, <b><a href="https://shapedplugin.com/logo-carousel/pricing/?ref=1" target="_blank">Upgrade To Pro</a></b>!', 'logo-carousel-free' ),
			),
			array(
	...
	array(
		'fields' => array(
			array(
				...
				'desc'       => __( ' To add a custom link URL for the logo, <a href="https://shapedplugin.com/logo-carousel/pricing/?ref=1" target="_blank">Upgrade To Pro!</a>', 'logo-carousel-free' ),
				'attributes' => array(
