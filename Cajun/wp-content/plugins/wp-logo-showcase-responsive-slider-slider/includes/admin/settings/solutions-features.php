	...
	<div class="wpls-sf-wrap">
		<div class="wpls-sf-inr">
			<div class="wpls-sf-features-section wpls-sf-team wpls-sf-center">
				...
				<h2>With <span class="wpls-sf-blue">35+ plugins</span>, <span class="wpls-sf-blue">2000+ templates</span> & $600 saving in <span class="wpls-sf-blue">Essential Plugin Bundle</span></h2>
				<h3><span style="text-decoration:line-through; color: #FF1000;">$299</span> <span class="wpls-sf-blue" style="font-size:30px;">$179</span> Unlimited Site License</h3>
				<a href="<?php echo WPLS_PLUGIN_BUNDLE_LINK; ?>" target="_blank" class="wpls-sf-btn wpls-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle Deal</a>
			...
			<div class="wpls-sf-features-section wpls-sf-team wpls-sf-center">
				<h1 class="wpls-sf-heading">Powerful Team Behind <span class="wpls-sf-blue">Logo Showcase </span>Including in <span class="wpls-sf-blue">Essential Plugin Bundle</span></h1>
					...
					<a href="<?php echo WPLS_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="wpls-sf-btn wpls-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Bundle Deal</a>
			</div>
			...
			<div class="wpls-sf-welcome-wrap">
				<div class="wpls-sf-welcome-inr wpls-sf-center">
						...
						<a href="<?php echo WPLS_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="wpls-sf-btn wpls-sf-btn-orange">View Bundle Deal</a>
