...
$carte_nouvelle = new WP_Query('post_type=nouvelle&showposts=6&category_name=vegan');
?>
...
<article>
                    ...
                    <div id="app">
                        ...
                        <hero srch="http://localhost:81/Cajun/wp-content/uploads/2022/11/recette_potage_brocoli.jpg" titre="RECETTES">
...
<a href="http://localhost:81/Cajun/recettes-2" style="text-decoration: none"><button class="bouton-suite">PAGE SUIVANTE</button></a>
